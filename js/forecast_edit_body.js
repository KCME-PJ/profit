document.addEventListener('DOMContentLoaded', function () {
    ...
    function getFormDataString() {
        ...
        const ignoreIds = [
            ...
            'bulkJsonData', 'forecastMode', 'fcStatus', 'updatedAt', 'targetOfficeId'
        ];
    ...
    if (officeSelect) {
        officeSelect.addEventListener('change', () => {
            ...
            const parentIdInput = document.getElementById('planId') || document.getElementById('monthlyForecastId') || document.getElementById('monthlyCpId') || document.getElementById('monthlyOutlookId') || document.getElementById('monthlyResultId');
    ...
    if (monthSelect) {
        monthSelect.addEventListener('change', function (e) {
            ...
            fetch(`forecast_edit_load.php?year=${year}&month=${month}`).then(response => response.json()).then(data => {
