document.addEventListener('DOMContentLoaded', function () {
    ...
    const btnParentFix = document.getElementById('outlookParentFixConfirmBtn');
    const btnParentUnlock = document.getElementById('outlookParentUnlockConfirmBtn');
    ...
    function getFormDataString() {
        ...
        const data = {};
        const ignoreIds = ['officeTimeData', 'officeSelect', 'hourlyRate', 'hiddenHourlyRate', 'totalHours', 'standardHours', 'overtimeHours', 'transferred_hours', 'fulltimeCount', 'contractCount', 'dispatchCount', 'bulkJsonData', 'outlookMode', 'olStatus', 'updatedAt', 'targetOfficeId'];
