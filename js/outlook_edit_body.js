document.addEventListener('DOMContentLoaded', function () {
    ...
    function resetInputFields() {
        ...
        // IDをリセット
        const idInput = document.getElementById('outlookId');
    ...
    // ---------------------------------------------
    // 引数から officeId を削除
    window.loadOutlookData = function (year, month) {
        if (!year || !month) return; // ★ 修正
    ...
    monthSelect.addEventListener('change', function () {
        ...
        window.loadOutlookData(year, month);
    });
    ...
    // ---------------------------------------------
    // --- 初期表示処理 (plan_edit_body.js L461-L478) ---
    // ---------------------------------------------
