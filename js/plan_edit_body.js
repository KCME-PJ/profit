document.addEventListener('DOMContentLoaded', function () {
    ...
    const btnParentFix = document.getElementById('planParentFixConfirmBtn');
    const btnParentUnlock = document.getElementById('planParentUnlockConfirmBtn');
    ...
    const BACKUP_KEY = 'plan_edit_backup_data';
    ...
    function backupFormData() {
        ...
        document.querySelectorAll('input, select, textarea').forEach(input => {
            const ignoreIds = ['planId', 'plStatus', 'updatedAt', 'bulkJsonData', 'officeTimeData', 'officeSelect', 'yearSelect', 'monthSelect', 'hourlyRate', 'hiddenHourlyRate', 'planMode', 'targetOfficeId'];
    ...
    function getFormDataString() {
        ...
        const data = {};
        const ignoreIds = ['officeTimeData', 'officeSelect', 'hourlyRate', 'hiddenHourlyRate', 'totalHours', 'standardHours', 'overtimeHours', 'transferred_hours', 'fulltimeCount', 'contractCount', 'dispatchCount', 'bulkJsonData', 'planMode', 'plStatus', 'updatedAt', 'targetOfficeId'];
    ...
    function updateButtonState() {
        ...
        const hasData = (planIdInput && planIdInput.value);
    ...
    function prepareAndSubmitForm(action) {
        ...
        if (document.getElementById('planMode')) document.getElementById('planMode').value = action;
    ...
    if (document.getElementById('planFixConfirmBtn')) document.getElementById('planFixConfirmBtn').addEventListener('click', function () { prepareAndSubmitForm('fixed'); });
    if (document.getElementById('planRejectConfirmBtn')) document.getElementById('planRejectConfirmBtn').addEventListener('click', function () { prepareAndSubmitForm('reject'); });
    if (document.getElementById('planParentFixConfirmBtn')) document.getElementById('planParentFixConfirmBtn').addEventListener('click', function () { prepareAndSubmitForm('parent_fix'); });
    if (document.getElementById('planParentUnlockConfirmBtn')) document.getElementById('planParentUnlockConfirmBtn').addEventListener('click', function () { prepareAndSubmitForm('parent_unlock'); });
    ...
    if (officeSelect) {
        officeSelect.addEventListener('change', () => {
            ...
            const hasParentData = document.getElementById('planId') && document.getElementById('planId').value;
        ...
        monthSelect.addEventListener('change', function (e) {
            ...
            fetch(`plan_edit_load.php?year=${year}&month=${month}`)
                ...
                .then(data => {
                    ...
                    if (document.getElementById('planId')) document.getElementById('planId').value = data.plan_id ?? '';
                    if (document.getElementById('plStatus')) document.getElementById('plStatus').value = data.status ?? '';
