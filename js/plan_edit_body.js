document.addEventListener('DOMContentLoaded', function () {
    ...
    // ★修正: 画面上のトリガーボタンのIDを正しく取得 (Confirmボタンではない)
    ...
    function getFormDataString() {
        ...
        const ignoreIds = [
            ...
            'bulkJsonData', 'planMode', 'plStatus', 'updatedAt', 'targetOfficeId'
        ];
    ...
    if (monthSelect) {
        monthSelect.addEventListener('change', function (e) {
            ...
            // 数名を requestParams に変更して、外側のスコープ変数との衝突を回避
            ...
            fetch(`plan_edit_load.php?year=${year}&month=${month}`).then(response => response.json()).then(data => {
