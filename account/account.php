...
<head>
    ...
    <title>勘定科目登録 - Profit index</title>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./account_list.php">勘定科目リスト</a></li>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0">勘定科目の登録</h4>
            <a href="account_list.php" class="btn btn-outline-secondary btn-sm">一覧に戻る</a>
        </div>

        <form action="./add_account.php" method="POST">
            <div class="mb-3">
                <label for="accountName" class="form-label">勘定科目名</label>
                <input type="text" class="form-control" id="accountName" name="account_name" placeholder="例: 雑給" required>
            </div>
            <div class="mb-3">
