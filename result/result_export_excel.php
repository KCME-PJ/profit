...
} elseif ($resultData['status'] !== 'fixed') {
    redirectWithError("【{$year}年度 {$month}月】の概算実績は未確定です。確定後に出力してください。", $year, $month);
}
...
header("Content-Disposition: attachment;filename=result_summary_{$year}_{$month}.xlsx"); // ファイル名を変更
