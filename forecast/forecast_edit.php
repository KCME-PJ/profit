        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="#" role="button" data-bs-toggle="dropdown">見通し</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./forecast_edit.php">見通し編集</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
        ...
        <form id="mainForm" action="forecast_update.php" method="POST">
            ...
            <div class="info-box">
                ...
                <div class="row align-items-end mb-2">
                    ...
                    <input type="hidden" id="fcStatus" name="status" value="">
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px;">金額（見通し）</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-warning" id="forecastRejectConfirmBtn">はい、差し戻す</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="parentFixModal" tabindex="-1" aria-labelledby="parentFixModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">キャンセル</button>
                            <button type="button" class="btn btn-primary" id="forecastParentFixConfirmBtn">月次確定する</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="parentUnlockModal" tabindex="-1" aria-labelledby="parentUnlockModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">キャンセル</button>
                            <button type="button" class="btn btn-danger" id="forecastParentUnlockConfirmBtn">ロック解除する</button>
                        </div>
                    </div>
                </div>
            </div>
