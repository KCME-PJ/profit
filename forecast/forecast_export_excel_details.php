...
foreach ($offices as $office) {
    ...
    $stmtExp->execute([':monthly_forecast_id' => $monthlyForecastId, ':office_id' => $officeId]);
...
header("Content-Disposition: attachment;filename=forecast_details_{$year}_{$month}.xlsx");
