...
require_once '../includes/outlook_ui_functions.php'; // (outlook用の関数を読み込み)
...
try {
    ...
    //4月始まりのソート順を適用 (plan_edit.php L23-L32 と同じ)
    ...
    // ★ 1. 収入カテゴリと収入項目を取得 (plan_edit.php L44-L73 からコピー)
    // --------------------------------------------------------
    ...
    // エラーハンドリング
    $accounts = [];
    $revenues = []; // ★ $revenues も catch に追加 (plan_edit.php L76)
}
...
<body>
    ...
    <div class="container mt-2">
        ...
        <?php endif; ?>
        <?php if (isset($_GET['success'])): // ★ success=1 ではなく存在チェックのみに変更 (plan_edit.php L189)
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px;">金額（月末見込）</th>
                        </tr>
                    </thead>
                    <tbody>
