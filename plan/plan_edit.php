...
require_once '../includes/plan_ui_functions.php'; // (plan用の関数を読み込み)
...
try {
    ...
    // ★ 1. 収入カテゴリと収入項目を取得 (forecast_edit.php L42-L73 からコピー)
    // --------------------------------------------------------
    ...
    // エラーハンドリング
    $accounts = [];
    $revenues = []; // ★ $revenues も catch に追加 (forecast_edit.php L76)
}
...
<body>
    ...
    <div class="container mt-2">
        ...
        <?php endif; ?>
        <?php if (isset($_GET['success'])): // ★ success=1 ではなく存在チェックのみに変更
